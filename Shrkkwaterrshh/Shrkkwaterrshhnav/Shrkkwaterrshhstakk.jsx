...
import ProductScreen from '../Shrkkwaterrshhscrr/ProductScreen';
import Shrkkwaterrshhtab from '../../Shrkkwaterrshhtab';
import Shrkkwaterrshhload from '../Shrkkwaterrshhcpn/Shrkkwaterrshhload';
import Shrkkwaterrshhonbrd from '../Shrkkwaterrshhscrr/Shrkkwaterrshhonbrd';
import Shrkkwaterrshhqizgmp from '../Shrkkwaterrshhscrr/Shrkkwaterrshhqizgmp';
// <Stack.Screen name="Shrkkwaterrshhload" component={Shrkkwaterrshhload} />
...
const Shrkkwaterrshhstakk = () => {
  ...
  OneSignal.initialize('21a48c62-3e6b-4f82-b350-8d1b6780a5f4');
  ...
  const Route = ({ isFatch }) => {
    ...
    return (
      <Stack.Navigator screenOptions={{ headerShown: false }}>
          ...
          <Stack.Screen
            name="Shrkkwaterrshhonbrd"
            component={Shrkkwaterrshhonbrd}
          />
          <Stack.Screen name="Shrkkwaterrshhtab" component={Shrkkwaterrshhtab} />
          <Stack.Screen
            name="Shrkkwaterrshhqizgmp"
            component={Shrkkwaterrshhqizgmp}
          />
        </Stack.Navigator>
    );
  };
...
export default Shrkkwaterrshhstakk;
